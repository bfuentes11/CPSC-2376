...
std::vector<Character> loadmonster(std::string& fileName);
void displaybattle();
void monsterattack();
void playerattack();
void attack();
...
int main()
{
	//using PP1 Solution since my code was almost 200 lines already.

	std::normal_distribution<int> randomHealth(30, 5);
	std::normal_distribution<int> randomStrength(5, 1);
